...
def command_handler(sent_message, user_message):
    ...
    answer = gpt3('jelaskan cara membuat pola bolero dengan skala kecil, dan jelaskan berapa itu skala kecil biasanya pada kertas')


    editMessage(chat_id, message_id, f"-- <b>Membuat Pola Bolero</b> --\n:[ Pola Bolero Skala Kecil ]:\n\n{answer}\n\n[ <b>https://adabitaylor.blogspot.com/2016/03/pola-bolero-sederhana.html?m=1</b> ]", InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="Re-Generate",callback_data='regenerate')]]))
    db.insert({'chat_id': chat_id, 'message_id': message_id, 'question': 'jelaskan cara membuat pola bolero dengan skala kecil, dan jelaskan berapa itu skala kecil biasanya pada kertas', 'answer': answer, 'header': '-- <b>Membuat Pola Bolero</b> --\n:[ Pola Bolero Skala Kecil ]:\n\n'})

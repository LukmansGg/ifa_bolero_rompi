...
def command_handler(sent_message, user_message):
    ...
    editMessage(chat_id, message_id, f"--- **Menyiapkan ukuran** ---\n[ Bentuk tubuh ]\n\nMengenali bentuk tubuh untuk mendapatkan pola busana yang pas pada pelanggan. Umumnya dikenali dari bentuk tubuh  terdiri dari artas ideal, tinggi kurus, tinggi gemuk, pendek kurus, pendek gemuk.\n\n{answer}", parse_mode="Markdown", InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="Panduan ukuran",callback_data='panduanUkuran')], [InlineKeyboardButton(text="video penjelasan 1⏸", url="https://youtu.be/f0fKHhow6Pc")], [InlineKeyboardButton(text="video penjelasan 2⏸", url="https://youtu.be/n8Mqed5zwH4")]]))
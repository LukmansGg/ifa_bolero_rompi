...
def callback_handler(msg):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text='Re-Generate', callback_data = 'sejarah')], [InlineKeyboardButton(text='« Back', callback_data = 'homepengertian')]])

...
def callback_handler(msg):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text='Regenerate', callback_data = 'regenerate')], [InlineKeyboardButton(text='« Back', callback_data = 'home_pengertian')]])

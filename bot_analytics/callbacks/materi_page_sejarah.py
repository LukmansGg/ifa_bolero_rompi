...
def callback_handler(msg):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text='Re-Generate', callback_data = 'sejarah')], [InlineKeyboardButton(text='« Back', callback_data = 'home_pengertian')]])

    question = 'jelaskan sejarah bolero dan rompi'
    response = gpt3(question)
    # Edit pesan asli dengan respon
    bot.editMessageText((from_id, original_message_id), f'-**Pengertian Bolero dan Rompi**-\n:[ Sejarah ]:\n\n{response}\n• https://www.womanindonesia.co.id/sejarah-jaket-bolero-di-industri-fashion/\n• https://kumparan.com/hijab-lifestyle/mengulik-sejarah-rompi-yang-sudah-populer-sejak-abad-ke-17-1y1JZmTp0ZL', parse_mode="Markdown", reply_markup=keyboard)

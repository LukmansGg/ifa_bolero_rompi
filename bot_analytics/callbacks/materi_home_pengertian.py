...
def callback_handler(msg):
    ...
    bot.editMessageText((from_id, original_message_id), text="Disini kita akan belajar Materi Pengertian tentang bolero/rompi berikut, pilih salah satu👇", reply_markup=InlineKeyboardMarkup(inline_keyboard=[
